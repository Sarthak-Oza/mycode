...
def ask_question(question, options):
    while True:
        try:
            ...
            print()
            choice = int(input(Back.GREEN + "Enter the number of your choice from above (1-5):"  + Style.RESET_ALL + " "))
            print()
...
def determine_age(answers):
    calculated_age = int(numpy.average(list(answer * 15 for answer in answers)))
...
def main():
    ...
    print(f"{Fore.YELLOW}{Back.BLUE}************  You are {Style.BRIGHT}{result}{Style.NORMAL} years old!  ************{Style.RESET_ALL}")
